export default function Header() {
  return (
    <header className="fixed top-0 isolate z-20 w-full bg-[#444]">
      <div className="container mx-auto flex h-[69px] w-full items-center justify-between overflow-hidden px-[10px]">
        {/* <!-- mobile nav menue  --> */}
        <div className="fixed top-[70px] mr-[-6px] hidden w-full max-w-screen-md bg-[#555]">
        ...
        <div className="flex h-[70px] w-full items-center justify-between lg:hidden">
          ...
          <div className="flex items-center gap-[20px]">
            <div className="cursor-pointer rounded-[3px] bg-[#555] p-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
